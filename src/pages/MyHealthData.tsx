...
const MyHealthData: React.FC<MyHealthDataProps> = ({ userId }) => {
    ...
    // chart.data = [{
    //   "name": "高",
    //   "value": dailyData.highStressDurationInSeconds,
    //   "color": am4core.color("#f56642")
    // }, {
    //   "name": "中",
    //   "value": dailyData.mediumStressDurationInSeconds,
    //   "color": am4core.color("#f59e42")
    // }, {
    //   "name": "低",
    //   "value": dailyData.lowStressDurationInSeconds,
    //   "color": am4core.color("#f5d442")
    // }, {
    //   "name": "休息",
    //   "value": dailyData.restStressDurationInSeconds,
	...
	// @ts-ignore
  // useEffect(async () => {
	// 	const result:any = await getLatestDataService(userId, DOMAIN.STRESS);
	// 	const latestData = result.data.latestData;
	// 	setDailyData(latestData);
	// 	initStressChart(latestData);
  // });
